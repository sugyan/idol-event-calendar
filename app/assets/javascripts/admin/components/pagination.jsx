    ...
    render() {
        ...
        var prev = (
            <li className={!this.props.prev ? "disabled" : null}>
                <a href={!this.props.prev ? null : this.makeHref(current - 1)} onClick={this.onClick.bind(this, current - 1)} aria-label="Previous">
        ...
        var next = (
            <li className={!this.props.next ? "disabled" : null}>
                <a href={!this.props.next ? null : this.makeHref(current + 1)} onClick={this.onClick.bind(this, current + 1)} aria-label="Next">
        ...
        if (this.props.current) {
            [1, 2, 3].forEach((e) => {
                ...
                if (page > 0) {
                    pages.unshift(
                        <li key={page}>
                            <a href={this.makeHref(page)} onClick={this.onClick.bind(this, page)}>{page}</a>
                        </li>
                    );
                }
            });
